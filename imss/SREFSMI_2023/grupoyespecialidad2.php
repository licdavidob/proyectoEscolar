...
<td><a href="Manual/Guiaayuda23IMSS.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong>Guía de Ayuda</strong></td>
...
faltanteh
FROM
cat_id_sec_2023 a LEFT JOIN vgrupoyespecialidad_2023vf b ON a.esp_tron_o_serv=b.esp_tron_o_serv AND b.clp='$clp' 
WHERE
gpo_serv='$grupo'
GROUP BY 
a.esp_tron_o_serv
...
FROM
requerimiento_2023 a LEFT JOIN cat_id_sec_2023 b ON a.producto=b.producto
WHERE
clp='$clp' AND
a.grupo='$grupo'
GROUP BY
