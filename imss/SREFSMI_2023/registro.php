...
<td><a href="Manual/Guiaayuda23IMSS.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong><label onClick="">Guía de Ayuda</label></strong></td>
...
b.pacientes
FROM
cat_id_sec_2023 a LEFT JOIN requerimiento_2023 b ON a.producto=b.producto AND clp='$clp'
WHERE
/*gpo_serv='$grupo'*/
gpo_serv='$grupo' AND
