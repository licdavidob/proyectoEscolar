...
error_reporting(0);
$pdf=$del.$file_name;
$query=mysql_query("SELECT * FROM pdf_bien_2023 WHERE del='$del'");

if(mysql_num_rows($query)>0)
mysql_query("DELETE FROM pdf_bien_2023 WHERE del='$del'");
mysql_query("INSERT INTO pdf_bien_2023 (del, delegoumae,pdf,fecsis,ipconfig) VALUES ('$del','$delegoumae','$pdf','$fecsis','$ipconfig')");
