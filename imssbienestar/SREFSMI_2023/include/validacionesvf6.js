...
var i=b;
	...
	var pac_reg;
		...
		faltantea=parseInt(document.getElementById('faltantea'+i).value);
		faltanteh=parseInt(document.getElementById('faltanteh'+i).value);
		excedentea=parseInt(document.getElementById('excedentea'+i).value);
		excedenteh=parseInt(document.getElementById('excedenteh'+i).value);	
	pac_reg=document.getElementById('pacientes'+i).value;

	
if(faltantea>0){tot=faltantea; } 	
	
if(faltanteh>0){
tot1=tot;
	tot= tot1+faltanteh; }
	if (excedentea>0){tot2 = tot; 
					  tot=tot2+excedentea;}
	if (excedenteh>0){tot3=tot
		tot=tot3+excedenteh;}

	if (pac_reg>tot){ 
	 document.getElementById('pacientes'+i).value='';
			alert("pacientes no puede ser mayor que la cantidad de eventos mensuales");
	}
		
		
/*		qexcedentea=document.getElementById('excedentea'+i).value;

		qexcedenteh=document.getElementById('excedenteh'+i).value;		
	
	qfaltantea=document.getElementById('faltantea'+i).value;

	qfaltanteh=document.getElementById('faltanteh'+i).value;	
