...
if (isset($_POST['del'])) 
{
	...
	$LoginRS__query=sprintf("SELECT del, pwd13 FROM delegaciones_bien_2023 WHERE del=%s AND pwd13=%s",
...
if($cerrado==1)
{
echo "<br><label style='color:red'>REGISTRO DE INFORMACIÓN CERRADO.</label> <br>Si requiere apertura, Solicitelo a su Administrador";
}
?>
</div>
