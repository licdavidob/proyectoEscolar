...
<td><a href="Manual/GAyuda23IMSSBienestar.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong><label onClick="">Guía de Ayuda</label></strong></td>
...
b.pacientes
FROM
cat_id_sec_2023 a LEFT JOIN requerimiento_bien_2023 b ON a.producto=b.producto AND clp='$clp'
WHERE
/*gpo_serv='$grupo'*/
gpo_serv='$grupo' AND
...
<strong>Nota 2: </strong> en caso de asesoría técnico - informática, contacte al Ing. Marco Fernando Andrade Cedillo</div>
	</td>
	</tr>
	<div id="contenido">
	<tr>
...
<input type="text" name="<?php echo "faltantea".$i;?>" id="<?php echo "faltantea".$i;?>" size="8" onKeyPress="if (event.keyCode &lt; 48 || event.keyCode &gt; 57) event.returnValue = false;" onKeyUp=" block('faltantea',<?php echo $i;?>)" style="text-align:right" value="<?php if($row["faltantea"]>0) echo number_format($row["faltantea"],0);?>"></td>
<td style="vertical-align:middle"> <!--number_format(this,<?php //echo $i;?>);-->
<input type="text" name="<?php echo "faltanteh".$i;?>" id="<?php echo "faltanteh".$i;?>" size="8" onKeyPress="if (event.keyCode &lt; 48 || event.keyCode &gt; 57) event.returnValue = false;" onKeyUp=" block('faltanteh',<?php echo $i;?>)" style="text-align:right" value="<?php if($row["faltanteh"]>0) echo number_format($row["faltanteh"],0);?>">     
	<!--number_format(this,<?php //echo $i;?>);-->
	</td>
...
<td style="vertical-align:middle">
<input type="text" name="<?php echo "excedentea".$i;?>" id="<?php echo "excedentea".$i;?>" size="8" onKeyPress="if(event.keyCode &lt; 48 || event.keyCode &gt; 57) event.returnValue = false;" onKeyUp=" block('excedentea',<?php echo $i;?>)" style="text-align:right" value="<?php if($row["excedentea"]>0) echo number_format($row["excedentea"],0);?>">
	<!--number_format(this,<?php //echo $i;?>);-->
	
	</td>
<td style="vertical-align:middle">
<input type="text" name="<?php echo "excedenteh".$i;?>" id="<?php echo "excedenteh".$i;?>" size="8" onKeyPress="if (event.keyCode &lt; 48 || event.keyCode &gt; 57) event.returnValue = false;" onKeyUp=" block('excedenteh',<?php echo $i;?>)" style="text-align:right" value="<?php if($row["excedenteh"]>0) echo number_format($row["excedenteh"],0);?>">
...
<input type="text" name="<?php echo "pacientes".$i;?>" id="<?php echo "pacientes".$i;?>" size="8" onKeyPress="if (event.keyCode &lt; 48 || event.keyCode &gt; 57) event.returnValue = false;" onKeyUp=" block('pacientes',<?php echo $i;?>); validacombo('text',this,<?php echo $i;?>)" style="text-align:right" value="<?php if($row["pacientes"]>0) echo number_format($row["pacientes"],0);?>"; onBlur="mayores(this,<?php echo $i;?>);">  <!--number_format(this,<?php //echo $i;?>);-->
