...
$query=mysql_query("SELECT del, delegoumae FROM cat_clues_bien_2023 WHERE del='$del'");
...
$pdf->SetY(32);
$pdf->SetX(20);
$pdf->MultiCell(246,4,utf8_decode("Recolección de Excedentes y Faltantes de Servicios Médicos Institucionales para el 2023"), 0, "C",0,0,0,0);
$pdf->Ln(5);
$pdf->SetX(20);
...
{	
	$pdf->SetXY(20,60);
	$pdf->MultiCell(246,4,utf8_decode('"'.$uno.' no reporta intervenciones Excedentes/Faltantes para el año 2023"'), 0, "C",0,0,0,0);
}
else if($um>1)
{
	if($umconr>1)
...
SELECT
	...
	pacientes
	FROM
	requerimiento_bien_2023 a LEFT JOIN cat_clues_bien_2023 b ON a.clp=b.clp2
WHERE
	b.del = '$del' AND
	excedentea>0
GROUP BY
