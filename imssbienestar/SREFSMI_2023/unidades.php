...
if($cerrado==1)
{
echo "<br><label style='color:red'>REGISTRO DE INFORMACIÓN CERRADO.</label> <br>Si requiere apertura, solicitelo via correo electronico a marco.andaradec@imss.gob.mx";
}
?>
</div><br>
...
FROM
cat_clues_bien_2023 a LEFT JOIN requerimiento_bien_2023 b ON a.clp2=b.clp
WHERE
a.del='$del'
GROUP BY
a.clp2
