...
if (isset($_POST['del'])) 
{
	...
	$LoginRS__query=sprintf("SELECT del, pwd13 FROM delegaciones_issste_2023  WHERE del=%s AND pwd13=%s",
...
<td><a href="Manual/GA23ISSSTE.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong>Guía de Ayuda</strong></td>
