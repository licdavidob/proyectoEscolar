...
{$$k=($v);}
	...
	$LoginRS__query=sprintf("SELECT del, pwd13 FROM delegaciones_pmx_2023  WHERE del=%s AND pwd13=%s",
...
<center>
<?php
$datos=mysql_query("SELECT delegoumae, tipo, numero, localidad FROM cat_clues_pmx_2023  WHERE del='$del'");
