...
FROM	
cat_clues_ss_2023  a 
LEFT JOIN pdf_ss_2023 b ON	a.del = b.del
WHERE
a.del='$del'
LIMIT 1 ");
        ...
        <tbody>
          ...
          <tr>
            ...
            <div align="center">             
			  ...
			  {
				  ?>
                  <a href="files/<?php echo $row[1];?>"><br><img src="Imagenes/pdf.jpeg"><br>Consultar PDF subido <?php echo $row[2];?></a>		<!--esta linea se modifico 12 04 2023 -->	  
				  <?php } ?>
			  </p><br>
            </div>			
			</td>			
...
<td style="background-color:#FFF; border:0; color:#000; font-size:18px" align="center">
	...
	{	
	?>
	<script type="text/javascript">alert("EL TAMAÑO MÁXIMO PERMITIDO ES DE 1000MB");</script>
	<?php
	}	
?>
</body>
