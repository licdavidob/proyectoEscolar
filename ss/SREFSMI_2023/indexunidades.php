...
if (isset($_POST['del'])) 
{
	...
	$LoginRS__query=sprintf("SELECT del, pwd13 FROM delegaciones_ss_2023  WHERE del=%s AND pwd13=%s",
...
<td><a href="Manual/Guia_ayuda_2021_ss_2023_2023.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong>Guía de Ayuda</strong></td>
