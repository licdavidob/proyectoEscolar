...
<td><a href="Manual/Guia_ayuda_2021_ss_2023_2023.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong><label onClick="window.location.href=''">Guía de Ayuda</label></strong></td>
...
faltanteh
FROM
cat_id_sec_2023  a LEFT JOIN vgrupoyespecialidad_ss_2023  b ON a.gpo_serv=b.grupo
AND
b.clp='$clp'
GROUP BY 
gpo_serva
