...
$query=mysql_query("SELECT del, delegoumae FROM cat_clues_ss_2023  WHERE del='$del'");
...
SELECT
	...
	pacientes
	FROM
requerimiento_ss_2023  a LEFT JOIN cat_clues_ss_2023  b ON a.clp=b.clp2
WHERE
	b.del = '$del' AND
	excedentea>0
GROUP BY
